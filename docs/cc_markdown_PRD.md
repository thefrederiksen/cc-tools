# cc_markdown - Product Requirements Document
...
# With custom CSS
cc_markdown input.md -o output.pdf --css mystyle.css
...
2. User can run `cc_markdown doc.md -o doc.pdf --theme Boardroom`
