...
REM ============================================
set "PYTHON_TOOLS=cc_crawl4ai cc_gmail cc_image cc_linkedin cc_markdown cc_outlook cc_reddit cc_setup cc_transcribe cc_vault cc_video cc_voice cc_whisper cc_youtube_info"
