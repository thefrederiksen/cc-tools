...
# Extract text (OCR)
cc_image ocr document.png

# Get image info
cc_image info photo.jpg

# Resize image
cc_image resize photo.jpg -o thumbnail.jpg --width 300

# Convert format
cc_image convert photo.png -o photo.jpg
```
...
cc_image generate "a cat wearing sunglasses" -o cat.png

# Different sizes
cc_image generate "prompt" -o out.png --size 1024x1024    # Square
cc_image generate "prompt" -o out.png --size 1024x1792    # Portrait
cc_image generate "prompt" -o out.png --size 1792x1024    # Landscape

# HD quality
cc_image generate "prompt" -o out.png --quality hd
```
...
# Analyze screenshot
cc_image describe screenshot.png
```
...
cc_image resize photo.jpg -o thumb.jpg --width 300

# Resize by height
cc_image resize photo.jpg -o thumb.jpg --height 200

# Custom quality (1-100)
cc_image resize photo.jpg -o thumb.jpg --width 300 --quality 85
```
...
cc_image convert photo.png -o photo.jpg --quality 90
```
...
```bash
cc_image generate "a modern software architecture diagram with microservices" -o architecture.png --size 1792x1024
```

### Extract Text from Screenshot

```bash
cc_image ocr error_message.png
```
...
```bash
cc_image describe flowchart.png
```
...
```bash
cc_image resize product.jpg -o product_thumb.jpg --width 150 --quality 85
```
...
```bash
for file in *.png; do
  cc_image convert "$file" -o "${file%.png}.jpg"
done
```
